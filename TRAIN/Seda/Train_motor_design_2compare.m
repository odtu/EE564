...
Hts=3460;  %Bts=1.6T ya karþýlýk olarak tablodan seçilmiþtir
...
%
% Stator back core flux intensity in A/m Bcs=1.43 from the table ý choose for the Bcs=1.45 
Hcs=1050; 
...
%%
% while starting the design efficiency is selected 91% but now it is 95%
% and for design it is not change the calculation very much only about 0.04
...
%% Conclusion
% The decrease of the aspect ratio, lot of parameters are effected  because
% it is effect firstly lenght of the motor. So motor torque, efficiency,
% cost etc are changed. Here I only change from 0.75 to 0.5 so changing of
% the parameter aren't seen clearly. Stator winding losses, rotor cage
% losses are decrease therefore total loss decreases and it directly
% effects the efficiency of the motor.
...
%
% *J. Pyrhönen and T. Jokinen "Design of Rotating Electrical Machines"
%
