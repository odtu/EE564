Core material is selected.

Problems over Matlab-publishing path are removed.

Operation point of flux density studies are ongoing. An optimization structure will be considered and applied to have less core loss.
...
Concluion is written and some updates are made to the rest of report. There might be still some upragreds but perhaps it is finished.

Projects outcomes are added to the end of report.